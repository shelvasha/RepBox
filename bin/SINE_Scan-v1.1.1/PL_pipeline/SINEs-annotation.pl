...
system "/home/maohlzj/ncbi-blast-2.2.31+/bin/makeblastdb -in $TEfile -dbtype nucl";
system "/home/maohlzj/ncbi-blast-2.2.31+/bin/makeblastdb -in ./SINEBase/SineDatabase.fasta -dbtype nucl";
